...
const TEXTOS = {
  ...
  pt: {
    ...
    /* A ajuda das calculadoras: para quem e', como se preenche cada campo, e
       um exemplo com as contas feitas. Viveu em portugues dentro do
       `ferramentas.js` desde que foi escrita — quem tinha a aplicacao em
       ingles abria "How to fill it in" e encontrava uma parede de portugues. */
    'ferr.a.resumo': 'Como se preenche — com um exemplo',
    'ferr.a.deixar': 'Já preenchido — se não souber o seu, deixe assim.',
    'ferr.t.p.sub': 'Vai pondo um bocadinho de lado todos os meses e quer ver quanto tem daqui a uns anos.',
    'ferr.a.p.c0.r': 'Guardo por mês',
    'ferr.a.p.c0.t': 'Quanto consegue pôr de lado por mês. Se são vinte, escreva 20.',
    'ferr.a.p.c1.r': 'Durante (anos)',
    'ferr.a.p.c1.t': 'Quantos anos pensa fazer isso.',
    'ferr.a.p.c2.r': 'Rende por ano (%)',
    'ferr.a.p.c2.t': 'Quanto o banco lhe paga por ter lá o dinheiro parado. Vem no papel da conta-poupança. <b>Se não souber, ou se guarda o dinheiro em casa, escreva 0</b> — a conta faz-se na mesma.',
    'ferr.a.p.ex': 'Vinte euros por mês durante cinco anos dá <b>1 200 €</b> — é o seu dinheiro, sem mais nada. Se estiver num sítio que renda 2% ao ano, dá <b>1 260,95 €</b>. Os <b>60,95 €</b> a mais não saíram do seu bolso.',
    'ferr.t.r.sub': 'Toda a gente diz para ter um dinheiro guardado para o que der e vier. Isto diz de quanto precisa, e quanto tempo demora a juntá-lo.',
    'ferr.a.r.c0.r': 'Essenciais por mês',
    'ferr.a.r.c0.t': 'Só o que não dá para deixar de pagar: casa, comida, luz, água, transporte, remédios. O resto não entra aqui.',
    'ferr.a.r.c1.r': 'Quero (meses)',
    'ferr.a.r.c1.t': 'Quantos meses quer aguentar se o dinheiro deixasse de entrar. <b>Comece por 1.</b> Três é o que se costuma dizer, mas um mês já muda a vida a quem não tem nenhum.',
    'ferr.a.r.c2.r': 'Já tenho',
    'ferr.a.r.c2.t': 'O que já está de lado. Se não é nada, escreva 0.',
    'ferr.a.r.c3.r': 'Guardo por mês',
    'ferr.a.r.c3.t': 'Quanto consegue pôr de lado por mês.',
    'ferr.a.r.ex': 'Se os essenciais são 600 € e quer três meses, a reserva é <b>1 800 €</b>. A 50 € por mês, demora <b>36 meses</b>. Se isso parecer longe de mais, escreva 1 mês em vez de 3: são 600 €, e chega lá num ano.',
    'ferr.t.q.sub': 'A loja diz «12x sem juros». Isto mostra se é mesmo sem juros.',
    'ferr.a.q.c0.r': 'Preço a pronto',
    'ferr.a.q.c0.t': 'O preço se pagasse tudo de uma vez, hoje. É o que responderem se perguntar «quanto é a pronto?».',
    'ferr.a.q.c1.r': 'Em quantas vezes',
    'ferr.a.q.c1.t': 'Em quantas prestações fica dividido.',
    'ferr.a.q.c2.r': 'Valor de cada prestação',
    'ferr.a.q.c2.t': 'Quanto paga em cada mês.',
    'ferr.a.q.ex': 'Uma máquina de lavar: <b>480 €</b> a pronto, ou <b>12 prestações de 45,90 €</b>. As doze prestações somam <b>550,80 €</b>. Paga <b>70,80 € a mais</b> — e isso é juro, mesmo que a loja diga que não há.',
    'ferr.t.d.sub': 'Tem mais do que uma dívida e não sabe qual pagar primeiro.',
    'ferr.a.d.c0.r': 'Dívida 1, 2 e 3',
    'ferr.a.d.c0.t': 'Quanto <b>ainda falta pagar</b> em cada uma — não o que pediu emprestado no princípio. Se só tem duas dívidas, deixe a terceira em 0.',
    'ferr.a.d.c1.r': 'Juro anual (%)',
    'ferr.a.d.c1.t': 'Quanto cada dívida cobra por ano. Está no contrato ou no extracto, às vezes com o nome <b>TAEG</b>. <b>Se não souber, escreva 0</b> — a ferramenta responde à mesma, só deixa de poder dizer qual sai mais cara.',
    'ferr.a.d.ex': 'Uma dívida de 300 € que cobra 18% ao ano, e outra de 1 200 € que cobra 9%. A de 1 200 € é maior, mas a de 300 € é a que sai mais cara por cada euro — e é a que se despacha mais depressa.',
    'ferr.t.e.sub': 'Saber que fatia do dinheiro que entra em casa fica presa só no tecto.',
    'ferr.a.e.c0.r': 'Entra em casa por mês',
    'ferr.a.e.c0.t': 'Tudo o que entra, de <b>todas as pessoas</b> da casa: salários, apoios, pensões, biscates.',
    'ferr.a.e.c1.r': 'Renda ou prestação',
    'ferr.a.e.c1.t': 'O que paga por mês pela casa. Só isso — a luz e a água não entram aqui.',
    'ferr.a.e.ex': 'Entram 1 000 € e a renda é 450 €. São <b>45%</b>: quase metade do que entra fica na casa antes de se comprar comida.',
    'ferr.t.h.sub': 'Uma coisa pequena que se repete muitas vezes. Ver quanto dá ao fim de um ano.',
    'ferr.a.h.c0.r': 'Custa de cada vez',
    'ferr.a.h.c0.t': 'O preço de uma vez só.',
    'ferr.a.h.c1.r': 'Vezes por semana',
    'ferr.a.h.c1.t': 'Quantas vezes numa semana normal. Não escolha a pior semana nem a melhor.',
    'ferr.a.h.ex': 'Um café de <b>1,20 €</b>, dez vezes por semana, dá <b>624 € por ano</b>. Isto não é para deixar de tomar café — é só para o número deixar de ser invisível.',
    'ferr.t.a.sub': 'Ver o ano inteiro à frente, mês a mês, com os subsídios no mês em que entram mesmo.',
    'ferr.a.a.c0.r': 'Entra por mês',
    'ferr.a.a.c0.t': 'O que entra num mês normal, <b>sem</b> contar subsídios.',
    'ferr.a.a.c1.r': 'Essenciais por mês',
    'ferr.a.a.c1.t': 'O que não dá para deixar de pagar.',
    'ferr.a.a.c2.r': 'O pagamento extra do ano',
    'ferr.a.a.c2.t': 'Em Portugal são dois — férias e Natal — e escreve-se o valor de <b>cada um</b>; entram em Junho e Novembro. No Brasil é o <b>13.º inteiro</b>, que entra em Novembro e Dezembro. <b>Se não recebe nada disso, escreva 0</b> — o plano faz-se à mesma.',
    'ferr.a.a.ex': 'Entram 1 000 € e os essenciais são 820 €: sobram 180 € por mês. Nos meses em que entra um subsídio sobra muito mais — e é aí que se junta a reserva do ano inteiro, não nos outros dez.',
    'ferr.t.c.sub': 'Tem duas hipóteses à frente e quer ver qual delas dá mais ao fim de uns anos.',
    'ferr.a.c.c0.r': 'A · por mês  e  B · por mês',
    'ferr.a.c.c0.t': 'Quanto punha de lado em cada uma das duas hipóteses.',
    'ferr.a.c.c1.r': 'A · rende (%)  e  B · rende (%)',
    'ferr.a.c.c1.t': 'Quanto cada uma paga por ano. <b>Se não souber, escreva 0 nas duas</b>: fica a comparar só o que consegue guardar, que é o que costuma pesar mais.',
    'ferr.a.c.c2.r': 'Durante (anos)',
    'ferr.a.c.c2.t': 'Quantos anos quer olhar à frente.',
    'ferr.a.c.ex': '50 € por mês num sítio que rende 2%, ou 80 € por mês num que rende 1%? Ao fim de dez anos: <b>6 635,98 €</b> contra <b>10 091,99 €</b>. Quanto se guarda pesou muito mais do que quanto rendeu.',
    'ferr.t.i.sub': 'Ver quantos anos faltariam, ao ritmo de hoje, para poder viver sem depender do salário.',
    'ferr.a.i.c0.r': 'Gasto por mês',
    'ferr.a.i.c0.t': 'Tudo o que gasta num mês, essencial e não essencial.',
    'ferr.a.i.c1.r': 'Poupo por mês',
    'ferr.a.i.c1.t': 'O que sobra e fica guardado.',
    'ferr.a.i.c2.r': 'Tenho hoje',
    'ferr.a.i.c2.t': 'Tudo o que já tem de lado, somado.',
    'ferr.a.i.c3.r': 'Rende por ano (%)',
    'ferr.a.i.c3.t': 'Quanto o dinheiro guardado rende por ano. <b>Se não souber, escreva 0.</b>',
    'ferr.a.i.ex': 'Este número costuma dar muitos anos, e não é para desanimar ninguém: serve para ver o efeito de mudar uma coisa de cada vez. <b>Não é uma previsão</b> — é a conta feita com os números que escreveu, e a vida não anda em linha recta.',

    /* As nove calculadoras. Os grupos e as tres seccoes ja' se traduziam;
       estas ficaram em portugues para toda a gente durante meses, porque os
       nomes eram `<h3>` escritos a' mao no HTML e ninguem lhes tinha posto
       chave. Quem tinha a aplicacao em ingles lia "Vale a pena parcelar?"
       ao lado de "My tax return". */
    'ferr.t.p': 'Quanto rende guardar todos os meses',
    'ferr.t.r': 'De quanto precisa a minha reserva',
    'ferr.t.q': 'Vale a pena parcelar?',
    'ferr.t.d': 'Por onde começar a pagar dívidas',
    'ferr.t.e': 'Quanto pesa a habitação',
    'ferr.t.h': 'O custo de um hábito',
    'ferr.t.a': 'Plano de 12 meses',
    'ferr.t.c': 'Comparar dois caminhos',
    'ferr.t.i': 'Quantos anos até não precisar de trabalhar',
    'ferr.selo': 'Assinatura',
    'ferr.bt.calcular': 'Calcular',
    'ferr.bt.comparar': 'Comparar',
    'ferr.bt.plano': 'Fazer o plano',
    'ferr.campo.p-mensal': 'Guardo por mês',
    'ferr.campo.p-anos': 'Durante (anos)',
    'ferr.campo.p-taxa': 'Rende por ano (%)',
    'ferr.campo.r-essenciais': 'Essenciais por mês',
    'ferr.campo.r-meses': 'Quero (meses)',
    'ferr.campo.r-tenho': 'Já tenho',
    'ferr.campo.r-pormes': 'Guardo por mês',
    'ferr.campo.q-pronto': 'Preço a pronto',
    'ferr.campo.q-vezes': 'Em quantas vezes',
    'ferr.campo.q-prestacao': 'Valor de cada prestação',
    'ferr.campo.d-valor1': 'Dívida 1',
    'ferr.campo.d-taxa1': 'Juro anual (%)',
    'ferr.campo.d-valor2': 'Dívida 2',
    'ferr.campo.d-taxa2': 'Juro anual (%)',
    'ferr.campo.d-valor3': 'Dívida 3',
    'ferr.campo.d-taxa3': 'Juro anual (%)',
    'ferr.campo.e-rendimento': 'Entra em casa por mês',
    'ferr.campo.e-habitacao': 'Renda ou prestação',
    'ferr.campo.h-valor': 'Custa de cada vez',
    'ferr.campo.h-vezes': 'Vezes por semana',
    'ferr.campo.a-rendimento': 'Entra por mês',
    'ferr.campo.a-essenciais': 'Essenciais por mês',
    'ferr.campo.a-extra': 'Subsídio, quando há (cada um)',
    'ferr.campo.c-mensalA': 'A · por mês',
    'ferr.campo.c-taxaA': 'A · rende (%)',
    'ferr.campo.c-mensalB': 'B · por mês',
    'ferr.campo.c-taxaB': 'B · rende (%)',
    'ferr.campo.c-anos': 'Durante (anos)',
    'ferr.campo.i-gasto': 'Gasto por mês',
    'ferr.campo.i-poupo': 'Poupo por mês',
    'ferr.campo.i-tenho': 'Tenho hoje',
    'ferr.campo.i-taxa': 'Rende por ano (%)',
  ...
  br: {
    ...
    'ferr.t.p.sub': 'Vai guardando um pouquinho todo mês e quer ver quanto vai ter daqui a uns anos.',
    'ferr.a.p.c0.r': 'Guardo todo mês',
    'ferr.a.p.c2.t': 'Quanto o banco te paga por deixar o dinheiro parado lá. Vem no papel da poupança. <b>Se não souber, ou se guarda o dinheiro em casa, escreva 0</b> — a conta se faz do mesmo jeito.',
    'ferr.a.p.ex': 'Vinte reais por mês durante cinco anos dá <b>1 200</b> — é o seu dinheiro, e mais nada. Se estiver num lugar que renda 2% ao ano, dá <b>1 260,95</b>. Os <b>60,95</b> a mais não saíram do seu bolso.',
    'ferr.t.r.sub': 'Todo mundo diz para ter um dinheiro guardado para o que der e vier. Isto diz de quanto você precisa, e quanto tempo leva para juntar.',
    'ferr.a.r.c0.t': 'Só o que não dá para deixar de pagar: moradia, comida, luz, água, transporte, remédio. O resto não entra aqui.',
    'ferr.a.r.c3.r': 'Guardo todo mês',
    'ferr.a.r.ex': 'Se os essenciais são 600 e você quer três meses, a reserva é <b>1 800</b>. A 50 por mês, leva <b>36 meses</b>. Se isso parecer longe demais, escreva 1 mês em vez de 3: são 600, e você chega lá num ano.',
    'ferr.a.q.c0.r': 'Preço à vista',
    'ferr.a.q.c0.t': 'O preço se você pagasse tudo de uma vez, hoje. É o que responderem se você perguntar «quanto é à vista?».',
    'ferr.a.q.c1.t': 'Em quantas parcelas fica dividido.',
    'ferr.a.q.c2.r': 'Valor de cada parcela',
    'ferr.a.q.ex': 'Uma máquina de lavar: <b>480</b> à vista, ou <b>12 parcelas de 45,90</b>. As doze parcelas somam <b>550,80</b>. Você paga <b>70,80 a mais</b> — e isso é juro, mesmo que a loja diga que não tem.',
    'ferr.a.d.c1.r': 'Juros ao ano (%)',
    'ferr.a.d.c1.t': 'Quanto cada dívida cobra por ano. Está no contrato ou no extrato, às vezes com o nome <b>CET</b>. <b>Se não souber, escreva 0</b> — a ferramenta responde do mesmo jeito, só deixa de poder dizer qual sai mais cara.',
    'ferr.a.d.ex': 'Uma dívida de 300 que cobra 18% ao ano, e outra de 1 200 que cobra 9%. A de 1 200 é maior, mas a de 300 é a que sai mais cara por cada real — e é a que se resolve mais rápido.',
    'ferr.a.e.c0.r': 'Entra em casa todo mês',
    'ferr.a.e.c0.t': 'Tudo o que entra, de <b>todas as pessoas</b> da casa: salários, benefícios, aposentadorias, bicos.',
    'ferr.a.e.c1.r': 'Aluguel ou prestação',
    'ferr.a.e.ex': 'Entram 1 000 e o aluguel é 450. São <b>45%</b>: quase metade do que entra fica na moradia antes de se comprar comida.',
    'ferr.a.h.ex': 'Um café de <b>1,20</b>, dez vezes por semana, dá <b>624 por ano</b>. Isto não é para você deixar de tomar café — é só para o número deixar de ser invisível.',
    'ferr.t.a.sub': 'Ver o ano inteiro pela frente, mês a mês, com o 13º e as férias no mês em que caem mesmo.',
    'ferr.a.a.c0.r': 'Entra todo mês',
    'ferr.a.a.c0.t': 'O que entra num mês normal, <b>sem</b> contar 13º nem férias.',
    'ferr.a.a.ex': 'Entram 1 000 e os essenciais são 820: sobram 180 por mês. Nos meses em que cai o 13º ou as férias sobra muito mais — e é aí que se junta a reserva do ano inteiro, não nos outros dez.',
    'ferr.t.c.sub': 'Tem duas opções pela frente e quer ver qual delas dá mais no fim de uns anos.',
    'ferr.a.c.c0.r': 'A · todo mês  e  B · todo mês',
    'ferr.a.c.c0.t': 'Quanto você guardaria em cada uma das duas opções.',
    'ferr.a.c.ex': '50 por mês num lugar que rende 2%, ou 80 por mês num que rende 1%? No fim de dez anos: <b>6 635,98</b> contra <b>10 091,99</b>. Quanto se guarda pesou muito mais do que quanto rendeu.',
    'ferr.a.i.c0.r': 'Gasto todo mês',
    'ferr.a.i.c1.r': 'Guardo todo mês',
    'ferr.t.p': 'Quanto rende guardar todo mês',
    'ferr.t.e': 'Quanto pesa a moradia',
    'ferr.t.i': 'Quantos anos até não precisar trabalhar',
    'ferr.campo.p-mensal': 'Guardo todo mês',
    'ferr.campo.r-pormes': 'Guardo todo mês',
    'ferr.campo.q-pronto': 'Preço à vista',
    'ferr.campo.q-prestacao': 'Valor de cada parcela',
    'ferr.campo.d-taxa1': 'Juros ao ano (%)',
    'ferr.campo.d-taxa2': 'Juros ao ano (%)',
    'ferr.campo.d-taxa3': 'Juros ao ano (%)',
    'ferr.campo.e-rendimento': 'Entra em casa todo mês',
    'ferr.campo.e-habitacao': 'Aluguel ou prestação',
    'ferr.campo.a-rendimento': 'Entra todo mês',
    'ferr.campo.a-extra': '13º ou férias, quando há (cada um)',
    'ferr.campo.c-mensalA': 'A · todo mês',
    'ferr.campo.c-mensalB': 'B · todo mês',
    'ferr.campo.i-gasto': 'Gasto todo mês',
    'ferr.campo.i-poupo': 'Guardo todo mês',
    'ferr.c.divida': 'O que a dívida custa',
  ...
  es: {
    ...
    'ferr.a.resumo': 'Cómo se rellena — con un ejemplo',
    'ferr.a.deixar': 'Ya está puesto — si no sabe el suyo, déjelo así.',
    'ferr.t.p.sub': 'Va apartando un poco todos los meses y quiere ver cuánto tendrá dentro de unos años.',
    'ferr.a.p.c0.r': 'Guardo al mes',
    'ferr.a.p.c0.t': 'Cuánto consigue apartar al mes. Si son veinte, escriba 20.',
    'ferr.a.p.c1.r': 'Durante (años)',
    'ferr.a.p.c1.t': 'Cuántos años piensa hacerlo.',
    'ferr.a.p.c2.r': 'Rinde al año (%)',
    'ferr.a.p.c2.t': 'Cuánto le paga el banco por tener allí el dinero parado. Viene en el papel de la cuenta de ahorro. <b>Si no lo sabe, o si guarda el dinero en casa, escriba 0</b> — la cuenta se hace igual.',
    'ferr.a.p.ex': 'Veinte euros al mes durante cinco años dan <b>1 200 €</b> — es su dinero, nada más. Si está en un sitio que rinda un 2% al año, dan <b>1 260,95 €</b>. Los <b>60,95 €</b> de más no salieron de su bolsillo.',
    'ferr.t.r.sub': 'Todo el mundo dice que hay que tener un dinero guardado por si acaso. Esto dice cuánto necesita, y cuánto tarda en juntarlo.',
    'ferr.a.r.c0.r': 'Esenciales al mes',
    'ferr.a.r.c0.t': 'Solo lo que no se puede dejar de pagar: casa, comida, luz, agua, transporte, medicinas. Lo demás no entra aquí.',
    'ferr.a.r.c1.r': 'Quiero (meses)',
    'ferr.a.r.c1.t': 'Cuántos meses quiere aguantar si dejara de entrar dinero. <b>Empiece por 1.</b> Tres es lo que se suele decir, pero un mes ya le cambia la vida a quien no tiene ninguno.',
    'ferr.a.r.c2.r': 'Ya tengo',
    'ferr.a.r.c2.t': 'Lo que ya está apartado. Si no es nada, escriba 0.',
    'ferr.a.r.c3.r': 'Guardo al mes',
    'ferr.a.r.c3.t': 'Cuánto consigue apartar al mes.',
    'ferr.a.r.ex': 'Si los esenciales son 600 € y quiere tres meses, el colchón es <b>1 800 €</b>. A 50 € al mes, tarda <b>36 meses</b>. Si eso parece demasiado lejos, escriba 1 mes en vez de 3: son 600 €, y llega en un año.',
    'ferr.t.q.sub': 'La tienda dice «12 cuotas sin intereses». Esto enseña si de verdad no los hay.',
    'ferr.a.q.c0.r': 'Precio al contado',
    'ferr.a.q.c0.t': 'El precio si lo pagara todo de una vez, hoy. Es lo que le respondan si pregunta «¿cuánto es al contado?».',
    'ferr.a.q.c1.r': 'En cuántas cuotas',
    'ferr.a.q.c1.t': 'En cuántas cuotas queda dividido.',
    'ferr.a.q.c2.r': 'Importe de cada cuota',
    'ferr.a.q.c2.t': 'Cuánto paga cada mes.',
    'ferr.a.q.ex': 'Una lavadora: <b>480 €</b> al contado, o <b>12 cuotas de 45,90 €</b>. Las doce cuotas suman <b>550,80 €</b>. Paga <b>70,80 € de más</b> — y eso es interés, aunque la tienda diga que no lo hay.',
    'ferr.t.d.sub': 'Tiene más de una deuda y no sabe cuál pagar primero.',
    'ferr.a.d.c0.r': 'Deuda 1, 2 y 3',
    'ferr.a.d.c0.t': 'Cuánto <b>falta todavía por pagar</b> en cada una — no lo que pidió prestado al principio. Si solo tiene dos deudas, deje la tercera en 0.',
    'ferr.a.d.c1.r': 'Interés anual (%)',
    'ferr.a.d.c1.t': 'Cuánto cobra cada deuda al año. Está en el contrato o en el extracto, a veces con el nombre <b>TAE</b>. <b>Si no lo sabe, escriba 0</b> — la herramienta responde igual, solo deja de poder decirle cuál sale más cara.',
    'ferr.a.d.ex': 'Una deuda de 300 € que cobra el 18% al año, y otra de 1 200 € que cobra el 9%. La de 1 200 € es mayor, pero la de 300 € es la que sale más cara por cada euro — y es la que se despacha antes.',
    'ferr.t.e.sub': 'Saber qué parte del dinero que entra en casa se queda solo en el techo.',
    'ferr.a.e.c0.r': 'Entra en casa al mes',
    'ferr.a.e.c0.t': 'Todo lo que entra, de <b>todas las personas</b> de la casa: sueldos, ayudas, pensiones, chapuzas.',
    'ferr.a.e.c1.r': 'Alquiler o hipoteca',
    'ferr.a.e.c1.t': 'Lo que paga al mes por la vivienda. Solo eso — la luz y el agua no entran aquí.',
    'ferr.a.e.ex': 'Entran 1 000 € y el alquiler es 450 €. Son el <b>45%</b>: casi la mitad de lo que entra se queda en la casa antes de comprar comida.',
    'ferr.t.h.sub': 'Una cosa pequeña que se repite muchas veces. Ver cuánto da al cabo de un año.',
    'ferr.a.h.c0.r': 'Cuesta cada vez',
    'ferr.a.h.c0.t': 'El precio de una sola vez.',
    'ferr.a.h.c1.r': 'Veces por semana',
    'ferr.a.h.c1.t': 'Cuántas veces en una semana normal. No escoja ni la peor semana ni la mejor.',
    'ferr.a.h.ex': 'Un café de <b>1,20 €</b>, diez veces por semana, da <b>624 € al año</b>. Esto no es para dejar de tomar café — es solo para que el número deje de ser invisible.',
    'ferr.t.a.sub': 'Ver el año entero por delante, mes a mes, con las pagas extra en el mes en que entran de verdad.',
    'ferr.a.a.c0.r': 'Entra al mes',
    'ferr.a.a.c0.t': 'Lo que entra en un mes normal, <b>sin</b> contar pagas extra.',
    'ferr.a.a.c1.r': 'Esenciales al mes',
    'ferr.a.a.c1.t': 'Lo que no se puede dejar de pagar.',
    'ferr.a.a.c2.r': 'La paga extra del año',
    'ferr.a.a.c2.t': 'En Portugal son dos — vacaciones y Navidad — y se escribe el importe de <b>cada una</b>; entran en junio y noviembre. En Brasil es el <b>13.º entero</b>, que entra en noviembre y diciembre. <b>Si no cobra nada de eso, escriba 0</b> — el plan se hace igual.',
    'ferr.a.a.ex': 'Entran 1 000 € y los esenciales son 820 €: sobran 180 € al mes. En los meses en que entra una paga extra sobra mucho más — y es ahí donde se junta el colchón del año entero, no en los otros diez.',
    'ferr.t.c.sub': 'Tiene dos opciones delante y quiere ver cuál da más al cabo de unos años.',
    'ferr.a.c.c0.r': 'A · al mes  y  B · al mes',
    'ferr.a.c.c0.t': 'Cuánto apartaría en cada una de las dos opciones.',
    'ferr.a.c.c1.r': 'A · rinde (%)  y  B · rinde (%)',
    'ferr.a.c.c1.t': 'Cuánto paga cada una al año. <b>Si no lo sabe, escriba 0 en las dos</b>: se queda comparando solo lo que consigue guardar, que es lo que suele pesar más.',
    'ferr.a.c.c2.r': 'Durante (años)',
    'ferr.a.c.c2.t': 'Cuántos años quiere mirar hacia delante.',
    'ferr.a.c.ex': '¿50 € al mes en un sitio que rinde el 2%, u 80 € al mes en uno que rinde el 1%? Al cabo de diez años: <b>6 635,98 €</b> frente a <b>10 091,99 €</b>. Cuánto se guarda pesó mucho más que cuánto rindió.',
    'ferr.t.i.sub': 'Ver cuántos años faltarían, al ritmo de hoy, para poder vivir sin depender del sueldo.',
    'ferr.a.i.c0.r': 'Gasto al mes',
    'ferr.a.i.c0.t': 'Todo lo que gasta en un mes, esencial y no esencial.',
    'ferr.a.i.c1.r': 'Ahorro al mes',
    'ferr.a.i.c1.t': 'Lo que sobra y queda guardado.',
    'ferr.a.i.c2.r': 'Tengo hoy',
    'ferr.a.i.c2.t': 'Todo lo que ya tiene apartado, sumado.',
    'ferr.a.i.c3.r': 'Rinde al año (%)',
    'ferr.a.i.c3.t': 'Cuánto rinde al año el dinero guardado. <b>Si no lo sabe, escriba 0.</b>',
    'ferr.a.i.ex': 'Este número suele dar muchos años, y no es para desanimar a nadie: sirve para ver el efecto de cambiar una cosa cada vez. <b>No es una previsión</b> — es la cuenta hecha con los números que escribió, y la vida no va en línea recta.',
    'ferr.t.p': 'Cuánto rinde guardar todos los meses',
    'ferr.t.r': 'Cuánto necesita mi colchón',
    'ferr.t.q': '¿Merece la pena pagar a plazos?',
    'ferr.t.d': 'Por dónde empezar a pagar deudas',
    'ferr.t.e': 'Cuánto pesa la vivienda',
    'ferr.t.h': 'El coste de una costumbre',
    'ferr.t.a': 'Plan de 12 meses',
    'ferr.t.c': 'Comparar dos caminos',
    'ferr.t.i': 'Cuántos años hasta no necesitar trabajar',
    'ferr.selo': 'Suscripción',
    'ferr.bt.calcular': 'Calcular',
    'ferr.bt.comparar': 'Comparar',
    'ferr.bt.plano': 'Hacer el plan',
    'ferr.campo.p-mensal': 'Guardo al mes',
    'ferr.campo.p-anos': 'Durante (años)',
    'ferr.campo.p-taxa': 'Rinde al año (%)',
    'ferr.campo.r-essenciais': 'Esenciales al mes',
    'ferr.campo.r-meses': 'Quiero (meses)',
    'ferr.campo.r-tenho': 'Ya tengo',
    'ferr.campo.r-pormes': 'Guardo al mes',
    'ferr.campo.q-pronto': 'Precio al contado',
    'ferr.campo.q-vezes': 'En cuántas cuotas',
    'ferr.campo.q-prestacao': 'Importe de cada cuota',
    'ferr.campo.d-valor1': 'Deuda 1',
    'ferr.campo.d-taxa1': 'Interés anual (%)',
    'ferr.campo.d-valor2': 'Deuda 2',
    'ferr.campo.d-taxa2': 'Interés anual (%)',
    'ferr.campo.d-valor3': 'Deuda 3',
    'ferr.campo.d-taxa3': 'Interés anual (%)',
    'ferr.campo.e-rendimento': 'Entra en casa al mes',
    'ferr.campo.e-habitacao': 'Alquiler o hipoteca',
    'ferr.campo.h-valor': 'Cuesta cada vez',
    'ferr.campo.h-vezes': 'Veces por semana',
    'ferr.campo.a-rendimento': 'Entra al mes',
    'ferr.campo.a-essenciais': 'Esenciales al mes',
    'ferr.campo.a-extra': 'Paga extra, cuando la hay (cada una)',
    'ferr.campo.c-mensalA': 'A · al mes',
    'ferr.campo.c-taxaA': 'A · rinde (%)',
    'ferr.campo.c-mensalB': 'B · al mes',
    'ferr.campo.c-taxaB': 'B · rinde (%)',
    'ferr.campo.c-anos': 'Durante (años)',
    'ferr.campo.i-gasto': 'Gasto al mes',
    'ferr.campo.i-poupo': 'Ahorro al mes',
    'ferr.campo.i-tenho': 'Tengo hoy',
    'ferr.campo.i-taxa': 'Rinde al año (%)',
  ...
  en: {
    ...
    'ferr.a.resumo': 'How to fill it in — with an example',
    'ferr.a.deixar': 'Already filled in — if you do not know yours, leave it.',
    'ferr.t.p.sub': 'You put a little aside every month and want to see what you will have in a few years.',
    'ferr.a.p.c0.r': 'I save each month',
    'ferr.a.p.c0.t': 'How much you manage to put aside each month. If it is twenty, write 20.',
    'ferr.a.p.c1.r': 'For (years)',
    'ferr.a.p.c1.t': 'How many years you expect to keep it up.',
    'ferr.a.p.c2.r': 'Returns per year (%)',
    'ferr.a.p.c2.t': 'What the bank pays you for leaving the money there. It is on the savings account paperwork. <b>If you do not know, or you keep the money at home, write 0</b> — the sum still works.',
    'ferr.a.p.ex': 'Twenty a month for five years is <b>1,200</b> — your own money, nothing else. Somewhere paying 2% a year, it is <b>1,260.95</b>. The extra <b>60.95</b> did not come out of your pocket.',
    'ferr.t.r.sub': 'Everyone says to keep money aside for whatever comes. This says how much you need, and how long it takes to get there.',
    'ferr.a.r.c0.r': 'Essentials each month',
    'ferr.a.r.c0.t': 'Only what you cannot stop paying: home, food, power, water, transport, medicines. Nothing else belongs here.',
    'ferr.a.r.c1.r': 'I want (months)',
    'ferr.a.r.c1.t': 'How many months you want to last if the money stopped coming in. <b>Start with 1.</b> Three is what people usually say, but one month already changes the life of someone who has none.',
    'ferr.a.r.c2.r': 'I already have',
    'ferr.a.r.c2.t': 'What is already set aside. If it is nothing, write 0.',
    'ferr.a.r.c3.r': 'I save each month',
    'ferr.a.r.c3.t': 'How much you manage to put aside each month.',
    'ferr.a.r.ex': 'If essentials are 600 and you want three months, the net is <b>1,800</b>. At 50 a month, that takes <b>36 months</b>. If that feels too far off, write 1 month instead of 3: that is 600, and you get there within a year.',
    'ferr.t.q.sub': 'The shop says "12 months interest free". This shows whether it really is.',
    'ferr.a.q.c0.r': 'Cash price',
    'ferr.a.q.c0.t': 'The price if you paid it all at once, today. It is what they answer when you ask "how much in cash?".',
    'ferr.a.q.c1.r': 'In how many instalments',
    'ferr.a.q.c1.t': 'How many instalments it is split into.',
    'ferr.a.q.c2.r': 'Amount of each instalment',
    'ferr.a.q.c2.t': 'What you pay each month.',
    'ferr.a.q.ex': 'A washing machine: <b>480</b> in cash, or <b>12 instalments of 45.90</b>. The twelve add up to <b>550.80</b>. You pay <b>70.80 more</b> — and that is interest, whatever the shop says.',
    'ferr.t.d.sub': 'You have more than one debt and do not know which to pay first.',
    'ferr.a.d.c0.r': 'Debt 1, 2 and 3',
    'ferr.a.d.c0.t': 'How much is <b>still left to pay</b> on each one — not what you borrowed at the start. With only two debts, leave the third at 0.',
    'ferr.a.d.c1.r': 'Yearly interest (%)',
    'ferr.a.d.c1.t': 'What each debt charges per year. It is in the contract or the statement, sometimes called <b>APR</b>. <b>If you do not know, write 0</b> — the tool still answers, it just cannot tell you which one costs most.',
    'ferr.a.d.ex': 'A debt of 300 charging 18% a year, and one of 1,200 charging 9%. The 1,200 one is bigger, but the 300 one costs more per unit — and it is the one you clear fastest.',
    'ferr.t.e.sub': 'To see what slice of the money coming in is taken by the roof alone.',
    'ferr.a.e.c0.r': 'Coming into the home each month',
    'ferr.a.e.c0.t': 'Everything that comes in, from <b>everyone</b> in the household: wages, benefits, pensions, odd jobs.',
    'ferr.a.e.c1.r': 'Rent or mortgage',
    'ferr.a.e.c1.t': 'What you pay each month for the home. That only — power and water do not belong here.',
    'ferr.a.e.ex': 'In comes 1,000 and the rent is 450. That is <b>45%</b>: almost half of what arrives stays in the home before any food is bought.',
    'ferr.t.h.sub': 'One small thing repeated many times. To see what it adds up to over a year.',
    'ferr.a.h.c0.r': 'Costs each time',
    'ferr.a.h.c0.t': 'The price of a single one.',
    'ferr.a.h.c1.r': 'Times a week',
    'ferr.a.h.c1.t': 'How many times in an ordinary week. Do not pick your worst week or your best.',
    'ferr.a.h.ex': 'A coffee at <b>1.20</b>, ten times a week, is <b>624 a year</b>. This is not about giving up coffee — it is about the number no longer being invisible.',
    'ferr.t.a.sub': 'To see the whole year ahead, month by month, with extra pay in the month it actually lands.',
    'ferr.a.a.c0.r': 'Coming in each month',
    'ferr.a.a.c0.t': 'What comes in during an ordinary month, <b>not</b> counting extra pay.',
    'ferr.a.a.c1.r': 'Essentials each month',
    'ferr.a.a.c1.t': 'What you cannot stop paying.',
    'ferr.a.a.c2.r': 'The extra pay of the year',
    'ferr.a.a.c2.t': 'In Portugal there are two — holiday and Christmas pay — and you write the value of <b>each one</b>; they land in June and November. In Brazil it is the <b>whole 13th salary</b>, paid across November and December. <b>If you get none of this, write 0</b> — the plan still works.',
    'ferr.a.a.ex': 'In comes 1,000 and essentials are 820: 180 left over each month. In the months when extra pay lands there is far more — and that is where the whole year of savings comes from, not from the other ten.',
    'ferr.t.c.sub': 'You have two options in front of you and want to see which gives more after a few years.',
    'ferr.a.c.c0.r': 'A · per month  and  B · per month',
    'ferr.a.c.c0.t': 'How much you would put aside under each of the two options.',
    'ferr.a.c.c1.r': 'A · returns (%)  and  B · returns (%)',
    'ferr.a.c.c1.t': 'What each one pays per year. <b>If you do not know, write 0 in both</b>: you are then comparing only what you manage to save, which is usually what weighs most.',
    'ferr.a.c.c2.r': 'For (years)',
    'ferr.a.c.c2.t': 'How many years ahead you want to look.',
    'ferr.a.c.ex': '50 a month somewhere paying 2%, or 80 a month somewhere paying 1%? After ten years: <b>6,635.98</b> against <b>10,091.99</b>. How much you save weighed far more than how much it earned.',
    'ferr.t.i.sub': 'To see how many years would be left, at today pace, to live without depending on a wage.',
    'ferr.a.i.c0.r': 'I spend each month',
    'ferr.a.i.c0.t': 'Everything you spend in a month, essential and not.',
    'ferr.a.i.c1.r': 'I save each month',
    'ferr.a.i.c1.t': 'What is left over and stays saved.',
    'ferr.a.i.c2.r': 'I have today',
    'ferr.a.i.c2.t': 'Everything you already have put by, added up.',
    'ferr.a.i.c3.r': 'Returns per year (%)',
    'ferr.a.i.c3.t': 'What the saved money earns per year. <b>If you do not know, write 0.</b>',
    'ferr.a.i.ex': 'This number usually comes out as many years, and it is not meant to discourage anyone: it is there to show the effect of changing one thing at a time. <b>It is not a forecast</b> — it is the sum done with the numbers you wrote, and life does not run in a straight line.',
    'ferr.t.p': 'What saving every month adds up to',
    'ferr.t.r': 'How big my safety net needs to be',
    'ferr.t.q': 'Is paying in instalments worth it?',
    'ferr.t.d': 'Which debt to pay off first',
    'ferr.t.e': 'How much housing weighs',
    'ferr.t.h': 'What a habit costs',
    'ferr.t.a': 'A 12-month plan',
    'ferr.t.c': 'Compare two paths',
    'ferr.t.i': 'How many years until work is optional',
    'ferr.selo': 'Subscription',
    'ferr.bt.calcular': 'Work it out',
    'ferr.bt.comparar': 'Compare',
    'ferr.bt.plano': 'Build the plan',
    'ferr.campo.p-mensal': 'I save each month',
    'ferr.campo.p-anos': 'For (years)',
    'ferr.campo.p-taxa': 'Returns per year (%)',
    'ferr.campo.r-essenciais': 'Essentials each month',
    'ferr.campo.r-meses': 'I want (months)',
    'ferr.campo.r-tenho': 'I already have',
    'ferr.campo.r-pormes': 'I save each month',
    'ferr.campo.q-pronto': 'Cash price',
    'ferr.campo.q-vezes': 'In how many instalments',
    'ferr.campo.q-prestacao': 'Amount of each instalment',
    'ferr.campo.d-valor1': 'Debt 1',
    'ferr.campo.d-taxa1': 'Yearly interest (%)',
    'ferr.campo.d-valor2': 'Debt 2',
    'ferr.campo.d-taxa2': 'Yearly interest (%)',
    'ferr.campo.d-valor3': 'Debt 3',
    'ferr.campo.d-taxa3': 'Yearly interest (%)',
    'ferr.campo.e-rendimento': 'Coming into the home each month',
    'ferr.campo.e-habitacao': 'Rent or mortgage',
    'ferr.campo.h-valor': 'Costs each time',
    'ferr.campo.h-vezes': 'Times a week',
    'ferr.campo.a-rendimento': 'Coming in each month',
    'ferr.campo.a-essenciais': 'Essentials each month',
    'ferr.campo.a-extra': 'Extra pay, when there is any (each)',
    'ferr.campo.c-mensalA': 'A · per month',
    'ferr.campo.c-taxaA': 'A · returns (%)',
    'ferr.campo.c-mensalB': 'B · per month',
    'ferr.campo.c-taxaB': 'B · returns (%)',
    'ferr.campo.c-anos': 'For (years)',
    'ferr.campo.i-gasto': 'I spend each month',
    'ferr.campo.i-poupo': 'I save each month',
    'ferr.campo.i-tenho': 'I have today',
    'ferr.campo.i-taxa': 'Returns per year (%)',
