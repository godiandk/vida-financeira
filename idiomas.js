...
const TEXTOS = {
  ...
  pt: {
    ...
    /* — as ferramentas, arrumadas pela pergunta — */
    'ferr.sub': 'Escolha pela pergunta que tem hoje. Toque numa para abrir.',
    'ferr.g.dividas': 'Estou a dever dinheiro',
    'ferr.g.dividas.sub': 'Saber quanto custa, por onde começar a pagar, e onde há ajuda de graça.',
    'ferr.g.guardar': 'Quero guardar dinheiro',
    'ferr.g.guardar.sub': 'De quanto precisa de lado, quanto tempo demora, e onde o pôr.',
    'ferr.g.gastar': 'Quero gastar menos',
    'ferr.g.gastar.sub': 'Onde é que o dinheiro se está a ir, e o que muda mesmo a conta.',
    'ferr.g.apoios': 'Dinheiro que talvez já seja seu',
    'ferr.g.apoios.sub': 'Apoios a que se tem direito e não se está a receber. Não é empréstimo.',
    'ferr.g.planear': 'Planear os próximos anos',
    'ferr.g.planear.sub': 'Estas três abrem com a assinatura. Tudo o resto é grátis para sempre.',
    'ferr.c.divida': 'O que a dívida custa',
    'ferr.c.dividasub': 'Quanto está a pagar de juros, com as taxas do seu país.',
    'ferr.c.investirsub': 'Onde é que o dinheiro está garantido, e quanto rende.',
    'ferr.c.apoios': 'Apoios que talvez não receba',
    'ferr.c.apoiossub': 'Quatro perguntas, e a lista do que pode pedir no seu país.',
    'menu.titulo': 'O que quer fazer?',
    'menu.lancar': 'Lançar um gasto',
    'menu.lancarsub': 'Vinte segundos, e o mês fica certo',
    'menu.mes': 'Ver o meu mês',
    'menu.messub': 'Tudo o que entrou e saiu, e para onde foi',
    'menu.contas': 'As contas que se repetem',
    'menu.contassub': 'Renda, luz, água — e um aviso antes de vencer',
    'menu.ferramentas': 'Ferramentas e calculadoras',
    'menu.ferramentassub': 'Dívidas, reserva, apoios: escolhe-se pela pergunta',
    'menu.escrever': 'Escrever',
    'menu.escreversub': 'Lance falando, e faça as contas antes de assinar',

    /* — a casa partilhada — */
    'ferr.g.casa': 'Somos dois nesta casa',
    'ferr.g.casa.sub': 'Ligar as duas contas para as contas de casa serem as mesmas nos dois telemóveis.',
    'casa.titulo': 'A nossa casa',
    'casa.sub': 'As mesmas contas nos dois telemóveis, em tempo real.',
    'casa.oque': 'Duas contas, as mesmas contas de casa. Um cria o código, o outro escreve-o, e a partir daí o que um lança aparece no telemóvel do outro em segundos.',
    'casa.semconta': 'Para partilhar as contas com quem vive consigo, cada um precisa da sua conta. É grátis e leva um minuto.',
    'casa.criarconta': 'Criar conta ou entrar',
    'casa.ligada': 'Esta casa está a ser partilhada. Tudo o que um lança aparece no telemóvel do outro em segundos.',
    'casa.aespera': 'A casa está criada e ainda é só sua. Dê o código à outra pessoa para ela entrar.',
    'casa.gerar': 'Criar o código da nossa casa',
    'casa.agerar': 'A criar…',
    'casa.validade': 'Vale 24 horas e serve uma vez. Depois disso, faz-se outro.',
    'casa.jatenho': 'Já tenho um código',
    'casa.entrar': 'Entrar nesta casa',
    'casa.entrou': 'Entrou. As contas passam a ser as mesmas nos dois telemóveis.',
    'casa.alguem': 'outra pessoa',
    'casa.voce': 'você',
    'casa.sair': 'Sair desta casa',
    'casa.sairconfirma': 'Sair da casa? Os movimentos ficam todos neste telemóvel — não se perde nada. A outra pessoa deixa de ver o que lançar a partir de agora.',
    'casa.saiu': 'Saiu da casa. Os movimentos ficaram consigo.',
    'casa.errofmt': 'Esse código não tem o formato certo. São oito letras e números, como VF-CASA-4K7P-9RTM.',
    'casa.erronao': 'Não encontrei esse código. Confirme se o copiou inteiro.',
    'casa.errousado': 'Esse código já foi usado. Peça outro a quem o criou.',
    'casa.erroexp': 'Esse código já passou das 24 horas. Peça um novo.',
  ...
  br: {
    ...
    'ferr.sub': 'Escolha pela pergunta que você tem hoje. Toque numa para abrir.',
    'ferr.g.dividas': 'Estou devendo',
    'ferr.g.dividas.sub': 'Saber quanto custa, por onde começar a pagar, e onde tem ajuda de graça.',
    'ferr.g.guardar': 'Quero guardar dinheiro',
    'ferr.g.guardar.sub': 'De quanto você precisa, quanto tempo demora, e onde deixar.',
    'ferr.g.gastar': 'Quero gastar menos',
    'ferr.g.gastar.sub': 'Para onde o dinheiro está indo, e o que muda mesmo a conta.',
    'ferr.g.apoios': 'Dinheiro que talvez já seja seu',
    'ferr.g.apoios.sub': 'Benefícios a que você tem direito e não está recebendo. Não é empréstimo.',
    'ferr.g.planear': 'Planejar os próximos anos',
    'ferr.g.planear.sub': 'Estas três abrem com a assinatura. Todo o resto é grátis para sempre.',
    'ferr.c.divida': 'O que a dívida custa',
    'ferr.c.dividasub': 'Quanto você está pagando de juros, com as taxas do seu país.',
    'ferr.c.investirsub': 'Onde o dinheiro está garantido, e quanto rende.',
    'ferr.c.apoios': 'Benefícios que talvez você não receba',
    'ferr.c.apoiossub': 'Quatro perguntas, e a lista do que dá para pedir no seu país.',
    'menu.titulo': 'O que você quer fazer?',
    'menu.lancar': 'Lançar um gasto',
    'menu.lancarsub': 'Vinte segundos, e o mês fica certo',
    'menu.mes': 'Ver o meu mês',
    'menu.messub': 'Tudo o que entrou e saiu, e para onde foi',
    'menu.contas': 'As contas que se repetem',
    'menu.contassub': 'Aluguel, luz, água — e um aviso antes de vencer',
    'menu.ferramentas': 'Ferramentas e calculadoras',
    'menu.ferramentassub': 'Dívidas, reserva, benefícios: escolhe pela pergunta',
    'menu.escrever': 'Escrever',
    'menu.escreversub': 'Lance falando, e faça as contas antes de assinar',

    'ferr.g.casa': 'Somos dois nesta casa',
    'ferr.g.casa.sub': 'Ligar as duas contas para as contas da casa serem as mesmas nos dois celulares.',
    'casa.sub': 'As mesmas contas nos dois celulares, em tempo real.',
    'casa.oque': 'Duas contas, as mesmas contas de casa. Um cria o código, o outro digita, e daí em diante o que um lança aparece no celular do outro em segundos.',
    'casa.semconta': 'Para dividir as contas com quem mora com você, cada um precisa da sua conta. É grátis e leva um minuto.',
    'casa.ligada': 'Esta casa está sendo compartilhada. Tudo o que um lança aparece no celular do outro em segundos.',
    'casa.aespera': 'A casa está criada e ainda é só sua. Passe o código para a outra pessoa entrar.',
    'casa.validade': 'Vale 24 horas e serve uma vez. Depois disso, faz-se outro.',
    'casa.jatenho': 'Já tenho um código',
    'casa.entrou': 'Entrou. As contas passam a ser as mesmas nos dois celulares.',
    'casa.sairconfirma': 'Sair da casa? Os movimentos ficam todos neste celular — não se perde nada. A outra pessoa deixa de ver o que você lançar daqui pra frente.',
    'casa.errofmt': 'Esse código não está no formato certo. São oito letras e números, tipo VF-CASA-4K7P-9RTM.',
    'casa.erronao': 'Não achei esse código. Confira se copiou inteiro.',
    'casa.errousado': 'Esse código já foi usado. Peça outro para quem criou.',
    'casa.erroexp': 'Esse código já passou das 24 horas. Peça um novo.',
  ...
  es: {
    ...
    /* — las herramientas, ordenadas por la pregunta — */
    'ferr.sub': 'Elija por la pregunta que tiene hoy. Toque una para abrirla.',
    'ferr.g.dividas': 'Tengo deudas',
    'ferr.g.dividas.sub': 'Saber cuánto cuesta, por dónde empezar a pagar, y dónde hay ayuda gratuita.',
    'ferr.g.guardar': 'Quiero ahorrar',
    'ferr.g.guardar.sub': 'Cuánto necesita tener aparte, cuánto tarda, y dónde ponerlo.',
    'ferr.g.gastar': 'Quiero gastar menos',
    'ferr.g.gastar.sub': 'Adónde se está yendo el dinero, y qué cambia de verdad la cuenta.',
    'ferr.g.apoios': 'Dinero que quizá ya es suyo',
    'ferr.g.apoios.sub': 'Ayudas a las que tiene derecho y no está cobrando. No es un préstamo.',
    'ferr.g.planear': 'Planificar los próximos años',
    'ferr.g.planear.sub': 'Estas tres se abren con la suscripción. Todo lo demás es gratis para siempre.',
    'ferr.c.divida': 'Lo que cuesta la deuda',
    'ferr.c.dividasub': 'Cuánto está pagando de intereses, con los tipos de su país.',
    'ferr.c.investirsub': 'Dónde está garantizado el dinero, y cuánto rinde.',
    'ferr.c.apoios': 'Ayudas que quizá no esté cobrando',
    'ferr.c.apoiossub': 'Cuatro preguntas, y la lista de lo que puede pedir en su país.',
    'menu.titulo': '¿Qué quiere hacer?',
    'menu.lancar': 'Apuntar un gasto',
    'menu.lancarsub': 'Veinte segundos, y el mes queda bien',
    'menu.mes': 'Ver mi mes',
    'menu.messub': 'Todo lo que entró y salió, y adónde fue',
    'menu.contas': 'Las cuentas que se repiten',
    'menu.contassub': 'Alquiler, luz, agua — y un aviso antes de vencer',
    'menu.ferramentas': 'Herramientas y calculadoras',
    'menu.ferramentassub': 'Deudas, colchón, ayudas: se elige por la pregunta',
    'menu.escrever': 'Escribir',
    'menu.escreversub': 'Apunte hablando, y haga las cuentas antes de firmar',

    /* — la casa compartida — */
    'ferr.g.casa': 'Somos dos en esta casa',
    'ferr.g.casa.sub': 'Unir las dos cuentas para que las cuentas de casa sean las mismas en los dos móviles.',
    'casa.titulo': 'Nuestra casa',
    'casa.sub': 'Las mismas cuentas en los dos móviles, en tiempo real.',
    'casa.oque': 'Dos cuentas, las mismas cuentas de casa. Uno crea el código, el otro lo escribe, y a partir de ahí lo que uno apunta aparece en el móvil del otro en segundos.',
    'casa.semconta': 'Para compartir las cuentas con quien vive con usted, cada uno necesita su cuenta. Es gratis y lleva un minuto.',
    'casa.criarconta': 'Crear cuenta o entrar',
    'casa.ligada': 'Esta casa se está compartiendo. Todo lo que uno apunta aparece en el móvil del otro en segundos.',
    'casa.aespera': 'La casa está creada y todavía es solo suya. Dele el código a la otra persona para que entre.',
    'casa.gerar': 'Crear el código de nuestra casa',
    'casa.agerar': 'Creando…',
    'casa.validade': 'Vale 24 horas y sirve una vez. Después se hace otro.',
    'casa.jatenho': 'Ya tengo un código',
    'casa.entrar': 'Entrar en esta casa',
    'casa.entrou': 'Ha entrado. Las cuentas pasan a ser las mismas en los dos móviles.',
    'casa.alguem': 'otra persona',
    'casa.voce': 'usted',
    'casa.sair': 'Salir de esta casa',
    'casa.sairconfirma': '¿Salir de la casa? Los movimientos se quedan todos en este móvil — no se pierde nada. La otra persona deja de ver lo que apunte a partir de ahora.',
    'casa.saiu': 'Ha salido de la casa. Los movimientos se quedaron con usted.',
    'casa.errofmt': 'Ese código no tiene el formato correcto. Son ocho letras y números, como VF-CASA-4K7P-9RTM.',
    'casa.erronao': 'No he encontrado ese código. Compruebe si lo copió entero.',
    'casa.errousado': 'Ese código ya se usó. Pida otro a quien lo creó.',
    'casa.erroexp': 'Ese código ya pasó de las 24 horas. Pida uno nuevo.',
  ...
  en: {
    ...
    /* — the tools, sorted by the question — */
    'ferr.sub': 'Pick by the question you have today. Tap one to open it.',
    'ferr.g.dividas': 'I owe money',
    'ferr.g.dividas.sub': 'What it costs, where to start paying, and where the free help is.',
    'ferr.g.guardar': 'I want to put money aside',
    'ferr.g.guardar.sub': 'How much you need, how long it takes, and where to keep it.',
    'ferr.g.gastar': 'I want to spend less',
    'ferr.g.gastar.sub': 'Where the money is going, and what actually changes the arithmetic.',
    'ferr.g.apoios': 'Money that may already be yours',
    'ferr.g.apoios.sub': 'Benefits you qualify for and are not claiming. Not a loan.',
    'ferr.g.planear': 'Planning the years ahead',
    'ferr.g.planear.sub': 'These three open with the subscription. Everything else is free for good.',
    'ferr.c.divida': 'What the debt costs',
    'ferr.c.dividasub': 'How much interest you are paying, with your country rates.',
    'ferr.c.investirsub': 'Where money is protected, and what it earns.',
    'ferr.c.apoios': 'Benefits you may not be claiming',
    'ferr.c.apoiossub': 'Four questions, and the list of what you can claim in your country.',
    'menu.titulo': 'What would you like to do?',
    'menu.lancar': 'Add an expense',
    'menu.lancarsub': 'Twenty seconds, and the month is right',
    'menu.mes': 'See my month',
    'menu.messub': 'Everything in and out, and where it went',
    'menu.contas': 'The bills that come every month',
    'menu.contassub': 'Rent, electricity, water — and a warning before they are due',
    'menu.ferramentas': 'Tools and calculators',
    'menu.ferramentassub': 'Debt, buffer, benefits: pick by the question',
    'menu.escrever': 'Write',
    'menu.escreversub': 'Enter things by talking, and do the sums before you sign',

    /* — the shared household — */
    'ferr.g.casa': 'There are two of us here',
    'ferr.g.casa.sub': 'Link both accounts so the household books are the same on both phones.',
    'casa.titulo': 'Our household',
    'casa.sub': 'The same books on both phones, live.',
    'casa.oque': 'Two accounts, one set of household books. One of you creates the code, the other types it in, and from then on whatever one enters shows up on the other phone within seconds.',
    'casa.semconta': 'To share the books with the person you live with, you each need your own account. It is free and takes a minute.',
    'casa.criarconta': 'Create an account or sign in',
    'casa.ligada': 'This household is shared. Whatever one of you enters shows up on the other phone within seconds.',
    'casa.aespera': 'The household is set up and still only yours. Give the code to the other person so they can join.',
    'casa.gerar': 'Create our household code',
    'casa.agerar': 'Creating…',
    'casa.validade': 'Good for 24 hours, and works once. After that, make another.',
    'casa.jatenho': 'I already have a code',
    'casa.entrar': 'Join this household',
    'casa.entrou': 'You are in. The books are now the same on both phones.',
    'casa.alguem': 'the other person',
    'casa.voce': 'you',
    'casa.sair': 'Leave this household',
    'casa.sairconfirma': 'Leave the household? Every entry stays on this phone — nothing is lost. The other person stops seeing what you enter from now on.',
    'casa.saiu': 'You left the household. The entries stayed with you.',
    'casa.errofmt': 'That code is not in the right shape. It is eight letters and numbers, like VF-CASA-4K7P-9RTM.',
    'casa.erronao': 'I could not find that code. Check that you copied all of it.',
    'casa.errousado': 'That code has already been used. Ask whoever made it for another.',
    'casa.erroexp': 'That code is more than 24 hours old. Ask for a new one.',
